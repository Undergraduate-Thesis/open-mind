    ...
    <div class="flex w-full items-start px-4 py-6">
      ...
      <div class="w-full">
        <div class="flex items-center justify-between">
          <h2 class="text-lg font-semibold text-gray-900 -mt-1">{{ comment.userName }}</h2>
            <button
...
export default {
  ...
  mounted() {
      ...
      this.comment.created_at = `${created_at.getDate()} ${created_at.toLocaleString('default', { month: 'short' })}`;
  },
  methods: {
    deleteComment() {
