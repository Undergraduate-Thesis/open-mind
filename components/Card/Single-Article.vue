    ...
    <div class="my-3 lg:flex lg:justify-center rounded-md bg-white">
      ...
      <div class="py-10 px-6 max-w-xl lg:max-w-5xl lg:w-3/5">
        ...
        <div class="flex items-center justify-between mt-8">
          <div>
            <nuxt-link to="/404" class="mx-2 hover:bg-gray-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="24"
                height="24"
                class="inline-block h-6 w-6 fill-current hover:bg-gray-200"
              >
              ...
              <p class="inline-block text-gray-600 font-semibold">Like it</p>
            </nuxt-link>
            <nuxt-link to="/404" class="mx-2 hover:bg-gray-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p class="inline-block text-gray-600 font-semibold">comments</p>
            </nuxt-link>
          </div>
